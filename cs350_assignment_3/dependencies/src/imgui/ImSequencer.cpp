...
#define CEDRIC_GUILLEMET_DO_YOUR_WORK 0
...
#if CEDRIC_GUILLEMET_DO_YOUR_WORK
    static int min(int a, int b) { return (a < b) ? a : b; }	// NOT USED!
    static int max(int a, int b) { return (a > b) ? a : b; }	// NOT USED!
#endif
...
#if CEDRIC_GUILLEMET_DO_YOUR_WORK
                float handleRadius = (scrollBarMax.y - scrollBarMin.y) / 2;	// NOT USED!
#endif
